...
//     // Navigate to notifications page with the notification ID in state
//     navigate("/notifications", {
//       state: { notificationId: notification._id }
//     });
//   };
...
export default function NotificationBell() {
  ...
  // Navigate to the full notifications list (no specific notification)
