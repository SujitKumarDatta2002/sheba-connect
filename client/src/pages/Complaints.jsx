...
// // Check for recently resolved complaints to show survey
// useEffect(() => {
//   const recentlyResolved = complaints.find(c => 
//     c.status === "Resolved" && 
//     !c.surveySubmitted &&
//     new Date(c.updatedAt) > new Date(Date.now() - 7 * 24 * 60 * 60 * 1000) // Within last 7 days
//   );
  
//   if (recentlyResolved) {
//     setResolvedComplaint(recentlyResolved);
//     setShowSurvey(true);
//   }
// }, [complaints]);
...
// ====================================================================`;
//   };
// {/* Add this in the complaint form modal, after the complaint details */}
...
//       onSelect={(solution) => {
//         // Handle solution selection - maybe pre-fill description or show in chat
...
====================================================================`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 pt-4">
      ...
      {showSolutionForm && selectedForSolution && (
        <SubmitSolution
