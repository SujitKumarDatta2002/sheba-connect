...
export default function Home({ user }) {
  ...
  // Fetch system-wide statistics (public endpoint - no auth required)
  useEffect(() => {
                ...
                {loading ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-2xl">{systemStats.totalUsers}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="flex items-center gap-2">
                        <FaClipboardList /> Total Complaints
                      </span>
                      <span className="font-bold text-2xl">{systemStats.totalComplaints}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="flex items-center gap-2">
                        <FaClock className="text-yellow-300" /> Pending
                      </span>
                      <span className="font-bold text-2xl text-yellow-300">{systemStats.pendingComplaints}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="flex items-center gap-2">
                        <FaCheckCircle className="text-green-300" /> Resolved
                      </span>
                      <span className="font-bold text-2xl text-green-300">{systemStats.resolvedComplaints}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="flex items-center gap-2">
                        <FaChartBar /> Resolution Rate
                      </span>
                      <span className="font-bold text-2xl">{systemStats.resolutionRate}%</span>
                    </div>
                  </div>
                )}
              </div>
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mx-6 my-4 rounded-lg shadow-md">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <FaExclamationCircle className="text-yellow-500 text-xl" />
                <p className="text-yellow-700">
                  <span className="font-semibold">Quick Tip:</span> Register now to file complaints and track your documents!
                </p>
              </div>
              <button 
                onClick={() => setShowQuickTip(false)}
        ...
        <section className="py-16 px-6 bg-blue-600 text-white">
          <div className="container mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="text-center">
                <div className="text-4xl font-bold mb-2">{systemStats.resolvedComplaints}+</div>
                <div className="text-blue-200">Complaints Resolved</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold mb-2">50+</div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-2/3 mb-8 md:mb-0">
              ...
              <p className="text-xl text-blue-100 mb-4">
                Track your activity and access government services
              </p>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 mx-6 my-4 rounded-lg shadow-md">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <FaExclamationCircle className="text-yellow-500 text-xl" />
              <p className="text-yellow-700">
                <span className="font-semibold">Quick Tip:</span> Check your personal complaint statistics in the Complaints section!
              </p>
            </div>
            <button 
              onClick={() => setShowQuickTip(false)}
      ...
      <section className="py-16 px-6 bg-white">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-4">Quick Access</h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Access the main features of ShebaConnect
          </p>
      ...
      <section className="py-16 px-6 bg-blue-600 text-white">
        <div className="container mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              <div className="text-4xl font-bold mb-2">{systemStats.totalUsers}+</div>
