...
//           <h2 className="text-xl font-bold mb-2">Complaint Tracking</h2>
//           <p>
//             Submit and track complaints with real-time status updates and timeline.
//           </p>
//         </div>

//         <div className="bg-white p-6 rounded-xl shadow">
//           <h2 className="text-xl font-bold mb-2">Service Guidance</h2>
//           <p>
//             Get recommendations and document requirements for government services.
//           </p>
//         </div>
...
//           <p>
//             Store and manage your government documents securely.
//           </p>
//         </div>
...
//         <p>© 2026 ShebaConnect | CSE471 Project</p>
//       </footer>
