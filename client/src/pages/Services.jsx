...
<<<<<<< HEAD
  FaExternalLinkAlt, FaInfoCircle, FaDollarSign
=======
  FaExternalLinkAlt, FaInfoCircle, FaDollarSign, FaBuilding,
  FaClock, FaUserCheck, FaFileAlt, FaMapMarkerAlt, FaTag,
  FaArrowRight, FaShieldAlt as FaShield, FaEnvelope
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
} from 'react-icons/fa';
...
// Color palettes
var DEPT_COLOR = {
  'Passport Office': { bg: '#EEEDFE', stroke: '#534AB7', text: '#534AB7', light: '#F5F4FF' },
  'Electricity': { bg: '#FAEEDA', stroke: '#BA7517', text: '#854F0B', light: '#FFF8F0' },
  'Road Maintenance': { bg: '#F1EFE8', stroke: '#5F5E5A', text: '#444441', light: '#F8F7F5' },
  'Waste Management': { bg: '#EAF3DE', stroke: '#3B6D11', text: '#27500A', light: '#F3F9EC' },
  'Health Services': { bg: '#FCEBEB', stroke: '#A32D2D', text: '#791F1F', light: '#FEF5F5' },
  'Education': { bg: '#EEEDFE', stroke: '#534AB7', text: '#3C3489', light: '#F5F4FF' },
  'Revenue': { bg: '#E1F5EE', stroke: '#0F6E56', text: '#085041', light: '#F0F9F5' },
  'Municipal Services': { bg: '#E6F1FB', stroke: '#185FA5', text: '#0C447C', light: '#F0F6FD' },
  'Police': { bg: '#E6F1FB', stroke: '#185FA5', text: '#0C447C', light: '#F0F6FD' },
  'Fire Service': { bg: '#FAECE7', stroke: '#993C1D', text: '#712B13', light: '#FEF7F4' },
  'Ambulance': { bg: '#FCEBEB', stroke: '#A32D2D', text: '#791F1F', light: '#FEF5F5' },
  default: { bg: '#F1EFE8', stroke: '#5F5E5A', text: '#444441', light: '#F8F7F5' },
};

var URGENCY_PILL = {
  low: { bg: '#EAF3DE', text: '#27500A', label: 'Low', icon: '🟢' },
  medium: { bg: '#FAEEDA', text: '#633806', label: 'Medium', icon: '🟡' },
  high: { bg: '#FAECE7', text: '#712B13', label: 'High', icon: '🟠' },
  emergency: { bg: '#FCEBEB', text: '#791F1F', label: 'Emergency', icon: '🔴' },
};
...
function MetaRow({ iconBg, icon: IconComp, label, children }) {
  return (
    <div className="flex items-start gap-2.5">
      <span className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: iconBg }}>
...
function ActionBtn({ href, to, bg, color, IconComp, label, disabled }) {
  var baseCls = 'flex flex-col items-center gap-1 py-2.5 rounded-xl text-xs font-semibold transition-all duration-200';
  
  if (disabled) {
    return (
      <span className={`${baseCls} opacity-40 cursor-not-allowed bg-gray-100 text-gray-400`}>
...
<<<<<<< HEAD
      <Link to={to} className={baseCls} style={activeStyle}>
        ...
        {label}
=======
      <Link to={to} className={`${baseCls} hover:scale-105 active:scale-95`} style={{ background: bg, color: color }}>
        <IconComp className="w-4 h-4" /> {label}
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
      </Link>
    );
...
<<<<<<< HEAD
  ...
  return (
    <a href={href} target={linkTarget} rel="noopener noreferrer" className={baseCls} style={activeStyle2}>
      ...
      {label}
=======
  var linkTarget = href && href.indexOf('http') === 0 ? '_blank' : '_self';
  return (
    <a href={href} target={linkTarget} rel="noopener noreferrer" className={`${baseCls} hover:scale-105 active:scale-95`} style={{ background: bg, color: color }}>
      <IconComp className="w-4 h-4" /> {label}
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
    </a>
  );
...
export default function Services() {
  ...
  var [helplines, setHelplines] = useState([]);
  var [loading, setLoading] = useState(false);
  var [showFilters, setShowFilters] = useState(false);
  var [filters, setFilters] = useState(EMPTY_FILTERS);
  var [helplineSearch, setHelplineSearch] = useState('');
  var [helplineCategory, setHelplineCategory] = useState('');
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-black" style={{ fontFamily: "'Georgia', serif" }}>
                Service & Helpline Directory
              </h1>
              <p className="text-blue-200 text-lg mt-1">
                Find government services and emergency contact numbers easily
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center border border-white/20">
              ...
              <div className="text-xs text-blue-300 mt-1">Government Services</div>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center border border-white/20">
              <div className="text-2xl font-bold">{helplines.length}</div>
              <div className="text-xs text-blue-300 mt-1">Emergency Helplines</div>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center border border-white/20">
              <div className="text-2xl font-bold">11+</div>
              <div className="text-xs text-blue-300 mt-1">Departments</div>
            </div>
            <div className="bg-white/10 backdrop-blur rounded-xl p-4 text-center border border-white/20">
              <div className="text-2xl font-bold">24/7</div>
              <div className="text-xs text-blue-300 mt-1">Support Available</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Modern Tabs */}
        <div className="flex gap-3 mb-8 bg-white rounded-2xl p-1.5 shadow-sm border border-gray-100 w-fit">
          <button
          ...
          >
            <FaBuilding className="text-sm" /> Government Services
          </button>
          <button
          ...
          >
            <FaPhone className="text-sm" /> Emergency & Departmental Helplines
          </button>
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
        </div>
              ...
              <div className="flex flex-col lg:flex-row gap-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                  />
                </div>
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 font-medium transition-all"
                  >
...
=======
              ...
              {showFilters && (
                <div className="mt-5 pt-5 border-t border-gray-100 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                  <div>
...
<<<<<<< HEAD
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
=======
                    <label className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Urgency Level</label>
                    <select
                      value={filters.urgency}
...
<<<<<<< HEAD
                    <label className="block text-sm font-medium text-gray-700 mb-2">Cost Range (BDT)</label>
=======
                    <label className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Cost Range (BDT)</label>
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                    <div className="flex gap-2">
                      <input
                        type="number" placeholder="Min"
...
=======
                        ...
                        className="w-1/2 px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                      />
                      <input
                        type="number" placeholder="Max"
                    ...
                    <div className="flex flex-wrap gap-2">
                      {DOCUMENT_OPTIONS.map(function(doc) {
                        ...
                        return (
                          <button key={doc.value} onClick={function() { toggleDocument(doc.value); }} className={btnCls}>
=======
                    <label className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Processing Time</label>
                    <input
                      type="text" placeholder="e.g., 3-5 days"
                      value={filters.processingTime}
                  ...
                  <div className="md:col-span-2 lg:col-span-4">
                    <label className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">Required Documents</label>
                    <div className="flex flex-wrap gap-2">
                      {DOCUMENT_OPTIONS.map(function(doc) {
                        var isActive = filters.requiredDocuments.indexOf(doc.value) !== -1;
                        return (
...
<<<<<<< HEAD
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                {services.map(function(service) {
                  ...
                  var callHref   = service.helpline ? 'tel:' + service.helpline : null;
                  var mapTo      = '/nearby?serviceId=' + service._id;
                  var applyTo    = '/apply-service/' + service._id;
=======
                      ...
                      <div className="px-5 pt-5 pb-4 border-b border-gray-100">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-2">
                            <span className="w-8 h-8 rounded-xl flex items-center justify-center" style={{ background: dept.bg }}>
                              <FaBuilding className="w-4 h-4" style={{ color: dept.stroke }} />
                            </span>
                            <span className="text-xs font-semibold" style={{ color: dept.text }}>{service.department}</span>
                          </div>
                          <span className="flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full" style={{ background: urg.bg, color: urg.text }}>
                            <span>{urg.icon}</span> {urg.label}
                          </span>
                        </div>
                        <h3 className="text-lg font-bold text-gray-800 mb-1 line-clamp-1">{service.name}</h3>
                        <p className="text-sm text-gray-500 line-clamp-2 leading-relaxed">{service.description}</p>
                      </div>

                      {/* Card Body */}
                      <div className="px-5 py-4 space-y-3">
                        <MetaRow iconBg="#EAF3DE" icon={FaClock} label="Processing">
                          <span className="text-sm font-medium text-gray-700">{service.processingTime}</span>
                        </MetaRow>
                        <MetaRow iconBg="#E1F5EE" icon={FaUserCheck} label="Eligibility">
                          <span className="text-sm text-gray-700 line-clamp-1">{service.eligibilityCriteria}</span>
                        </MetaRow>
                        {service.location && (
                          <MetaRow iconBg="#FBEAF0" icon={FaMapMarkerAlt} label="Location">
                            <span className="text-sm text-gray-700 line-clamp-1">{service.location}</span>
                          </MetaRow>
                        )}
                        <div className="h-px bg-gray-100 my-1" />
                        <MetaRow iconBg="#EEEDFE" icon={FaFileAlt} label="Documents">
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                          <div className="flex flex-wrap gap-1">
                            {service.requiredDocuments.length > 0
                              ? service.requiredDocuments.map(function(doc, i) {
...
<<<<<<< HEAD
                                    <span key={doc} className="px-1.5 py-px rounded text-xs font-medium" style={{ background: c.bg, color: c.text }}>
=======
                                    <span key={doc} className="px-2 py-0.5 rounded-md text-xs font-medium" style={{ background: c.bg, color: c.text }}>
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                                      {docLabel}
                                    </span>
                                  );
...
<<<<<<< HEAD
                        ...
                        <MetaRow iconBg="#E1F5EE" icon={IconCheck} label="Cost">
                          <span className="text-sm font-semibold" style={{ color: '#0F6E56' }}>
=======
                              : <span className="text-sm text-gray-400">None required</span>
                            }
                          </div>
                        </MetaRow>
                        <MetaRow iconBg="#E1F5EE" icon={FaTag} label="Cost">
...
=======
                      {/* Card Footer Actions */}
                      <div className="grid grid-cols-4 gap-2 px-5 pb-5 pt-2">
                        <ActionBtn href={service.website} bg="#E6F1FB" color="#0C447C" IconComp={FaGlobe} label="Website" disabled={!service.website} />
                        <ActionBtn href={callHref} bg="#EAF3DE" color="#27500A" IconComp={FaPhone} label="Call" disabled={!service.helpline} />
                        <ActionBtn href={mailtoHref} bg="#EEEDFE" color="#26215C" IconComp={FaEnvelope} label="Email" disabled={!service.email} />
                        <ActionBtn to={mapTo} bg="#FCEBEB" color="#791F1F" IconComp={FaMapMarkerAlt} label="Map" />
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                      </div>
                    </div>
                  );
...
=======
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                  />
                </div>
                <select
...
=======
                  ...
                  className="px-5 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-medium"
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                >
                  <option value="">All Categories</option>
                  {HELPLINE_CATEGORIES.map(function(c) {
                    ...
                    <div key={helpline._id} className="bg-white border border-gray-100 rounded-2xl overflow-hidden flex flex-col transition-all duration-200 hover:border-gray-300 hover:shadow-md">
                      ...
                      <div className="flex items-center gap-3 px-4 py-4 flex-shrink-0" style={{ background: s.hdrBg }}>
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-sm font-semibold text-gray-800 truncate">{helpline.name}</h3>
=======
                    <div key={helpline._id} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200 hover:-translate-y-1">
                      
                      {/* Card Header */}
                      <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100" style={{ background: s.hdrBg }}>
                        <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm" style={{ background: s.iconBg }}>
                          <Icon className="w-6 h-6 text-white" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <h3 className="font-bold text-gray-800 truncate">{helpline.name}</h3>
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                          <p className="text-xs font-medium mt-0.5" style={{ color: s.catText }}>{helpline.category}</p>
                        </div>
                        <div className="flex flex-col gap-1 flex-shrink-0">
...
<<<<<<< HEAD
                          ...
                          {helpline.available24x7 && (
                            <span className="px-2 py-0.5 rounded-full text-xs font-medium" style={{ background: '#EAF3DE', color: '#27500A' }}>24/7</span>
=======
                            <span className="px-2 py-0.5 rounded-full text-[10px] font-bold" style={{ background: '#FCEBEB', color: '#791F1F' }}>🚨 EMERGENCY</span>
                          )}
                          {helpline.available24x7 && (
                            <span className="px-2 py-0.5 rounded-full text-[10px] font-bold" style={{ background: '#EAF3DE', color: '#27500A' }}>🕐 24/7</span>
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                          )}
                        </div>
                      </div>
...
=======
                      ...
                      <div className="px-5 pt-4 pb-3">
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">📞 CONTACT NUMBERS</p>
                        <div className="space-y-2">
                          {helpline.numbers.map(function(num, i) {
                            var telHref = 'tel:' + num;
                            return (
                              <a key={i} href={telHref} className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all hover:scale-[1.02] group/call" style={{ background: s.numBg }}>
                                <svg viewBox="0 0 14 14" fill="none" width="14" height="14" style={{ flexShrink: 0 }}>
                                  <path d="M2.5 2.5h3l1 3-1.5 1A7 7 0 008.5 10l1-1.5 3 1V12c0 .6-.5 1-1 1C4 13 1 10 1 5.5c0-.5.5-1 1-1l.5-2z" stroke={s.numStroke} strokeWidth="1.2"/>
                                </svg>
                                <span className="text-base font-bold flex-1" style={{ color: s.numText }}>{num}</span>
                                <FaArrowRight className="w-3.5 h-3.5 opacity-0 group-hover/call:opacity-100 transition-opacity" style={{ color: s.numText }} />
                              </a>
                            );
                          })}
                        </div>
                      ...
                      {helpline.website && (
                        <div className="px-5 pb-3">
                          <a href={helpline.website} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-gray-50 hover:bg-gray-100 transition group/website">
                            <FaGlobe className="w-4 h-4 text-gray-400 flex-shrink-0" />
                            <span className="text-sm font-medium text-gray-600 flex-1 truncate">Visit official website</span>
                            <FaExternalLinkAlt className="w-3 h-3 text-gray-400 opacity-0 group-hover/website:opacity-100 transition" />
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
                          </a>
                        </div>
                      )}
                        ...
                        <div className="px-5 pb-5">
                          <div className="bg-gray-50 rounded-xl p-3">
                            <p className="text-xs text-gray-600 leading-relaxed">
                              <FaInfoCircle className="inline mr-1.5 text-gray-400" />
                              {helpline.description}
                            </p>
                          </div>
>>>>>>> 3c8289d15fa9d470ef64cf6f98721546cd2e5dc1
